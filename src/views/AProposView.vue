  ...
  <div class="about">
    ...
    <div id="container">
        ...
        <section class="open-book">
            ...
            <article>
                <h2 class="chapter-title">Cyan Henaff</h2>
                <p>
                  Je suis étudiante en Bachelor Universitaire des Métiers du Multimédias et de l'Internet à l'Université de Nouvelle-Calédonie. J'ai 21 ans.
                </p>
                <p>
                    Compétences, Formation, Expérience pro
                </p>
                <p>
